...
#### 🥈 Silver Layer — Silver Layer — [Silver_Layer.ipynb](./Medallion%20architecture/Silver_layer/Silver_Layer.ipynb)
...
#### 🥇 Gold Layer — [Gold_Layer.ipynb](./Medallion%20architecture/Gold_layer/Gold_Layer.ipynb)
...
#### 📈 EDA & AI Insights — [EDA.ipynb](./Exploratory_data_analysis/EDA.ipynb)
